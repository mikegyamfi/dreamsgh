        ...
        if send_bundle_response.status_code == 200:
            if data["code"] == "200":
                ...
                response1 = requests.get(
                    f"https://sms.arkesel.com/sms/api?action=send-sms&api_key=UnBzemdvanJyUGxhTlJzaVVQaHk&to=0{request.user.phone}&from=DreamsGH&sms={sms_message}")
                print(response1.text)

                response2 = requests.get(
                    f"https://sms.arkesel.com/sms/api?action=send-sms&api_key=UnBzemdvanJyUGxhTlJzaVVQaHk&to={phone_number}&from=DreamsGH&sms={receiver_message}")
                ...
                if transaction_channel == "ishare":
                    ...
                    if send_bundle_response != "bad response":
                        ...
                        if send_bundle_response["data"]["request_status_code"] == "200" or send_bundle_response["request_message"] == "Successful":
                            ...
                            response1 = requests.get(
                                f"https://sms.arkesel.com/sms/api?action=send-sms&api_key=UnBzemdvanJyUGxhTlJzaVVQaHk&to=0{user.phone}&from=DreamsGH&sms={sms_message}")
                            print(response1.text)
